...
/**
 * Serializes the email verification window message for the Pixel Protocol client.
 */
public class EmailVerificationWindowMessageComposer extends MessageComposer {
    ...
    /**
     * Creates a email verification window message composer instance for the network message subsystem.
     *
