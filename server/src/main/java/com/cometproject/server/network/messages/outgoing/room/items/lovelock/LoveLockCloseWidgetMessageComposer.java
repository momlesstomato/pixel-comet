...
/**
 * Serializes the love lock close widget message for the Pixel Protocol client.
 */
public class LoveLockCloseWidgetMessageComposer extends MessageComposer {
    private final int itemId;

    /**
     * Creates a love lock close widget message composer instance for the network message subsystem.
     *
