...
/**
 * Serializes the love lock widget message for the Pixel Protocol client.
 */
public class LoveLockWidgetMessageComposer extends MessageComposer {
    private final int itemId;

    /**
     * Creates a love lock widget message composer instance for the network message subsystem.
     *
