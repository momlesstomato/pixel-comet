...
import com.cometproject.server.game.permissions.PermissionService;
...
import com.cometproject.server.storage.jooq.HikariJooqDslProvider;
import com.cometproject.server.storage.jooq.IJooqDslProvider;
import com.cometproject.server.storage.jooq.repositories.JooqCurrencyRepository;
import com.cometproject.server.storage.jooq.repositories.JooqPermissionRepository;
import com.cometproject.server.storage.jooq.repositories.JooqPlayerRepository;
...
public final class CometCoreModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(HikariConnectionProvider.class).in(Scopes.SINGLETON);
        bind(IJooqDslProvider.class).to(HikariJooqDslProvider.class).in(Scopes.SINGLETON);
        bind(ICurrencyRepository.class).to(JooqCurrencyRepository.class).in(Scopes.SINGLETON);
        bind(ICurrencyService.class).to(CurrencyService.class).in(Scopes.SINGLETON);
        bind(IPermissionRepository.class).to(JooqPermissionRepository.class).in(Scopes.SINGLETON);
        bind(IPermissionService.class).to(PermissionService.class).in(Scopes.SINGLETON);
        bind(IPlayerRepository.class).to(JooqPlayerRepository.class).in(Scopes.SINGLETON);
