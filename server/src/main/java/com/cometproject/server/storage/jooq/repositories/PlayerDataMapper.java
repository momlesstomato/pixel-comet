...
final class PlayerDataMapper {
    ...
    static PlayerData fromPlayerRecord(final Record record) {
        return new PlayerData(
                ...
                value(record, "vip_points", Integer.class),
                value(record, "activity_points", Integer.class),
                value(record, "seasonal_points", Integer.class),
                value(record, "black_money", Integer.class),
