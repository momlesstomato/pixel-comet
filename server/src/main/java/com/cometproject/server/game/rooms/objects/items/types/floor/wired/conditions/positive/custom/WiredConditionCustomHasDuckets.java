...
/**
 * Describes wired condition custom has duckets behavior for the room subsystem.
 */
public class WiredConditionCustomHasDuckets extends WiredConditionItem {
    public static int PARAM_DUCKETS_ID = 0;

    /**
     * Creates a wired condition custom has duckets instance for the room subsystem.
     *
