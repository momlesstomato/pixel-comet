...
public class BattlePassGlobals {
    public static ArrayList<BattlePassMission> battlePassMissions = new ArrayList<BattlePassMission>(){{
        ...
        add(new BattlePassMission(2, "Actualiza tu mision 5 veces", 5, BattlePassMissionEnums.MissionType.CHANGEMISSION, BattlePassRewardEnum.RewardType.CURRENCY, "35", "https://cdn.discordapp.com/attachments/882679902162288651/1007356969398575174/2do-nivel.png"));
        ...
        add(new BattlePassMission(4, "Respeta a 10 personas", 10, BattlePassMissionEnums.MissionType.RESPECTUSER, BattlePassRewardEnum.RewardType.CURRENCY, "50", "https://cdn.discordapp.com/attachments/882679902162288651/1007356970493280437/4to-nivel.png"));
        add(new BattlePassMission(5, "Juega al menos 5 partidas de la rouleta normal", 5, BattlePassMissionEnums.MissionType.PLAYCASINO, BattlePassRewardEnum.RewardType.CURRENCY, "65", "https://cdn.discordapp.com/attachments/882679902162288651/1007356970803662979/5to-nivel.png"));
        ...
        add(new BattlePassMission(7, "Crea 6 salas nuevas", 6, BattlePassMissionEnums.MissionType.CREATEROOM, BattlePassRewardEnum.RewardType.CURRENCY, "75", "https://cdn.discordapp.com/attachments/882679902162288651/1007356971466371082/7mo-nivel.png"));
        add(new BattlePassMission(8, "Besa 30 veces", 30, BattlePassMissionEnums.MissionType.KISSPLAYER, BattlePassRewardEnum.RewardType.CURRENCY, "90", "https://cdn.discordapp.com/attachments/882679902162288651/1007356971797717042/8vo-nivel.png"));
