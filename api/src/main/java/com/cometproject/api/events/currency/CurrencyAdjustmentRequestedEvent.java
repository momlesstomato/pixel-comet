...
/**
 * Cancellable event fired before a currency adjustment is validated and persisted.
 */
public final class CurrencyAdjustmentRequestedEvent extends CancellableCurrencyEvent {
    ...
    /**
     * Creates a currency adjustment event from a request object.
     *
     * @param request the requested currency adjustment.
     */
    public CurrencyAdjustmentRequestedEvent(final CurrencyAdjustmentRequest request) {
    ...
    /**
     * Converts the possibly modified event back to a request object.
     *
